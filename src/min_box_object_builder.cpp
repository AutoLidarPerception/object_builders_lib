...
namespace object_builder {
    ...
    void MinBoxObjectBuilder::build(const std::vector<PointICloudPtr>& cloud_clusters,
    ...
    void MinBoxObjectBuilder::build(ObjectPtr object)
    {
        buildObject(object);
    }

    void MinBoxObjectBuilder::setDefaultValue(PointICloudPtr cloud, ObjectPtr obj,
     ...
     *  ObjectPtr->polygon Convex Hull of the object(物体凸边框) projected into xy-plane
     */
    void MinBoxObjectBuilder::computePolygon2dxy(ObjectPtr obj)
    {
        ...
        // epsilon: the difference between 1.0 and the next value representable by the floating-point type
        ...
        //TODO Apollo's pcl::ConvexHull is memory-efficient
    ...
    void MinBoxObjectBuilder::reconstructPolygon3d(ObjectPtr obj)
    {
        ...
        //TODO <1> Find the longest line in Convex Hull
        ...
        //TODO <2> 其它顶点投影到最长边得到矩形边框长边边长(total_len),宽边边长(max_dis)
        double total_len = 0;
        double max_dis = 0;
        bool has_out = false;
        ...
        //TODO<3> 求解所有以最长边投影的可能矩形中面积最小的那个
        size_t count = 0;
     ...
     *  length: longest distance between points projected into <Edge: first_in_point->index>
                                                        ...
                                                        double* length, double* width, Eigen::Vector3d* dir)
    {
        ...
        for (size_t i = 0; i < obj->polygon.points.size(); ++i) {
            if (i != first_in_point && i != index) {
                ...
                k = k * -1;
                // n is pedal of src
                //TODO Projected to <Edge: first_in_point->index>???
                n[0] = (b[0] - a[0]) * k + a[0];
                n[1] = (b[1] - a[1]) * k + a[1];
                n[2] = 0;
                ...
                //TODO highest triangle contributes the width of the Polygon
                if (height > wid) {
                    wid = height;
                    v = o;
                    vn = n;
        ...
        //TODO longest distance between points projected into <Edge: first_in_point->index>
        //TODO  contributes the length of the Polygon
        size_t point_num1 = 0;
        size_t point_num2 = 0;
         ...
         *  ns[point_num1]/ns[point_num2]: longest distance's points projected into <Edge: first_in_point->index>
         */
        ...
        /*
         * TODO only a 2D direction
         *  <Edge: first_in_point->index> is the direction: 2 projected points' vector
         *  <Edge: first_in_point->index> vertical to the direction: wid's edge vector
         */
        if (len > wid) {
        ...
        //TODO length & width are interchangeable
